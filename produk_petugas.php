    ...
    <body>
        ...
        <main>
            <div class="daftar">
                ...
                <a href="tampil_produk.php">edit</a>
                </h2>
                <?php
                ...
                <div class="list-produk">
                    ...
                    <a class="btn btn-hapus" href="hapus.php?id_produk=<?=$dt_produk['id_produk']?>" onclick="return confirm('Apakah anda yakin menghapus data ini?')">Hapus</a>
            </div>
            <?php
                }
            ?>
